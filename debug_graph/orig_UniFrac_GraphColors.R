...
View(tax3.clean)
#meta data
meta = read.table("/Volumes/LaCie/2019 Dissertation Data/2019_05_16_HenleyLakeDissertation/Henley Lake Dissertation Graphs and Analysis/R Studio Directory/Cartozzo_HenleyLake/HenleyLake_Scapula_Season_R_microbiota.txt", header=TRUE, sep = "\t")
#, stringsAsFactors = FALSE
View(meta)
row.names(meta) = meta$Sample
#force the order here 

meta$ADDCollectionDays <- factor(meta$ADDCollectionDays, levels=c("0/Baseline/0","249/Collection1/23","489/Collection2/72","727/Collection3/114",
