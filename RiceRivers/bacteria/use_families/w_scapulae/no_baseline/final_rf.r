...
## RMSE: 506.441871   5.077224
c(mean(fullRsq), 1.96*sd(fullRsq))
## Rsq: 0.926262265 0.001478122
...
ggsave(filename="families_scap_no_baseline_PercIncMSE_barchart.pdf", height=4.5, width=6, units="in")
## ##################################################
...
ggsave("infl_scap_family_no_baseline_scatter.pdf", width=8, height=4, units="in")
## ##################################################
