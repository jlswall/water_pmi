...
## to consider at each split is about 26. (With numBtSamps==3000, this
## has the 2nd smallest avgcvMSE and lowest avgcvErrFrac.)  However,
## using values of 24-29 for numVarSplit yielded very similar results.
numVarSplit <- 26
## ##################################################
...
## RMSE: 476.623507   5.650746
c(mean(fullRsq), 1.96*sd(fullRsq))
## Rsq: 0.931728595 0.001618951
...
ggsave(filename="families_rib_no_baseline_PercIncMSE_barchart.pdf", height=4.5, width=6, units="in")
## ##################################################
...
ggsave("infl_rib_family_no_baseline_scatter.pdf", width=8, height=4, units="in")
## ##################################################
