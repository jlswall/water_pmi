...
set.seed(590507)   # For 1 run per combo
...
# Write this info out.
write.csv(residDF, file="resids_leave_out_one_rib_and_one_day.csv",
  row.names=FALSE)
# #########################################
...
# This is about 802-809, whether I use 1, 10, or 100 runs per
# combo.
# #########################################
...
ggsave(filename="leave_out_one_rib_and_one_day_residuals.pdf", height=3.5,
  width=3.5, units="in")
