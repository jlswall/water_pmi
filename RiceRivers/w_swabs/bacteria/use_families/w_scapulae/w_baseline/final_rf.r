...
# each split is anywhere from about 25-37.  We go with 32 as a decent compromise
# between avgcvMSE and avgcvErrFrac.
numVarSplit <- 32
## ##################################################
...
fullResultsL <- future_lapply(repDataL, FUN=fitFullDataF, mtry=numVarSplit,
  ntree=numBtSamps, future.seed=as.integer(406071))
...
## RMSE: 693.29910  15.93102
c(mean(fullRsq), 1.96*sd(fullRsq))
## Rsq: 0.75744714 0.01114805
...
ggsave(filename="families_scapula_swab_w_baseline_PercIncMSE_barchart.pdf",
...
ggsave("infl_scapula_swab_w_baseline_family_scatter.pdf",
