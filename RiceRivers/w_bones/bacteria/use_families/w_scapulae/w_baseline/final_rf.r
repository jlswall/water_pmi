...
# Move back to wide format.  There are 115 samples (including 5 at ADD 0) and
# 55 taxa.
wideT <- taxaT %>%
  filter(taxon!="Rare") %>%
...
## has 2nd lowest avgcvMSE, and second lowest avgcvErrFrac).  However,
## using values of 18-21 for numVarSplit yielded very similar results.
numVarSplit <- 20
## ##################################################
...
## RMSE: 501.089180   5.066087
c(mean(fullRsq), 1.96*sd(fullRsq))
## Rsq: 0.933136462 0.001351946
