...
## to consider at each split is about 30 (lowest avgcvMSE, and second
## lowest avgcvErrFrac).  However, using values of 27-32 for
## numVarSplit yielded very similar results.
numVarSplit <- 30
## ##################################################
...
## 1 run per combo: 651.5784
## 10 runs per combo: 654.3859
## 100 runs per combo: 653.2
## This is about 651-655, whether I use 1, 10, or 100 runs per
## combo.
## #########################################
