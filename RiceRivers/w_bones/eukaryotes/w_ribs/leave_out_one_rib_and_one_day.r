...
## to consider at each split is about 14 (with 3000 bootstrap samples,
## lowest avgcvMSE and 2nd lowest avgcvErrFrac) for the response
## variable in original units.  Also, 13 is very close.  Note that
## there are only 14 predictors, so this means considering all of them
## at every split.
numVarSplit <- 14
## ##################################################
...
## With 1 run per combo: 817.5832
## With 10 runs per combo: 818.6047
## With 100 runs per combo: 818.9011
## This is about 817-819, whether I use 1, 10, or 100 runs per
## combo.
## #########################################
