...
# Filter data to just scapulae, allowing baseline observations.
...
# Filter data to just ribs, allowing baseline observations.
...
ggsave(file="rr_scapula_bones_vs_swabs_w_baseline_4panels.pdf", height=5, width=7.5,
  units="in")
# ########################
# ##################################################
...
ggsave(file="rr_scapula_bones_vs_swabs_w_baseline_predicted_vs_actual_ADD.pdf",
