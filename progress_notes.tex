...
\begin{frame}{Percentages unclassifed at the family level}
  ...
  {\footnotesize
  \begin{itemize}
  \item Water samples had the lowest percentage of taxa classified the family
  level, over the whole time period.
  \item For ADD above 3000, rib samples had a surprisingly high percentage of
