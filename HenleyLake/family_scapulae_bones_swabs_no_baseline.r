...
ggsave(file="hl_scapula_bones_vs_swabs_no_baseline_4panels.pdf", height=5, width=7.5,
  units="in")
# ########################
# ##################################################
...
ggsave(file="hl_scapula_bones_vs_swabs_no_baseline_predicted_vs_actual_ADD.pdf",
