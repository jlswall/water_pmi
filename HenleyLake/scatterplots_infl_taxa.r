...
# Filter data to just ribs and scapulae (no water).
...
# Filter data to just ribs and scapulae).  Swab data only includes ribs and
# scapula, but leaving this in for consistency with bones data.
