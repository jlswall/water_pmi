...
\begin{frame}{Data sources}
  ...
  \begin{itemize}
  \item Ribs: 154 family-level taxa listed
  \item Scapulae: 210 family-level taxa listed
  \item Water: 216 family-level taxa listed
  \end{itemize}

  \vspace{0.1in}

  \noindent Class data from \texttt{Taxlevel 3-Class} worksheet
  \begin{itemize}
  \item Ribs: 95 family-level taxa listed
  \item Scapulae: 124 family-level taxa listed
  \item Water: 127 family-level taxa listed
  \end{itemize}
...
\begin{frame}{Percentages unclassified at the class level}

  \begin{center}
    \begin{figure}
      \includegraphics[width=3.25in]{class_perc_classif_by_add_type}
    \end{figure}
  \end{center}
  \vspace{-0.1in}
  {\footnotesize
  \begin{itemize}
    \item Percentages classified to family level: 94.4\% (ribs), 93.5\%
    (scapulae), 87.2\% (water).
  \end{itemize}
  }
\end{frame}
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Class-level taxa]{Working with class-level taxa}

\begin{frame}{Which taxa were included?}

  \noindent For each sample, we calculated the total counts of all classified,
class-level taxa.  Then, for each sample, we calculated the fraction of counts
associated with each class-level taxa.  (Raw counts were \textbf{not} used.)

  \vspace{0.1in}

  \noindent As we did for the family-level analysis, we require that a taxon
  makes up more than 1\% of the total counts for at least 2 samples.
...
\begin{itemize}
\item The model utilized 11 class-level taxa.
\item Cross-validation was used to determine that the best number of taxa to
consider at each "branching" was 5.
\end{itemize}

\vspace{0.1in}

\noindent For the fitted model (using all available rib data):\\
\noindent RMSE: 624 $\pm$ 6.8  \hspace{0.05in}  Explained variation: 84.7\%
$\pm$ 0.3\%
...
\begin{frame}{Which taxa are influential in the random forest model?}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=3.25in]{use_classes/w_ribs/classes_rib_PercIncMSE_barchart}
    \end{figure}
  \end{center}
  \vspace{-0.1in}
  {\scriptsize
  ...
  \item The measure of importance is the mean percentage increase in the
    mean-square error of model predictions when the variable is left out of the
    model. 
  \item All 11 taxa used in the analysis are shown (since they fit).
  \end{itemize}
  }
...
\begin{frame}{Scatterplots for influential taxa}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=4.75in]{use_classes/w_ribs/infl_rib_class_scatter}
    \end{figure}
  \end{center}
  \vspace{-0.25in}
  {\scriptsize
  ...
  \item I've only shown top 6 because more than that is hard to fit.
  \item Note that the y-axes have differing scales.
  \item Fractions of Ignavibacteria, 4C0d-2, and Betaproteobacteria are very
  low.
  \end{itemize}
  }
...
\begin{frame}{Residual plot to get sense of "real-life" model fit}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=2.2in]{use_classes/w_ribs/classes_leave_out_one_rib_and_one_day_residuals}
      \caption{Residuals when leaving out one rib and one ADD at a time}
    \end{figure}
  \end{center}
  \vspace{-0.1in}
{\scriptsize
\begin{itemize}
  \item This RMSE is about 808, which is higher than the RMSE for the full
  dataset (as you'd expect).
  \item The errors tend to be larger at the upper extreme.
\end{itemize}
}
...
\begin{itemize}
\item The model utilized 17 class-level taxa.
\item Cross-validation was used to determine that the best number of taxa to
consider at each "branching" was 7.
\end{itemize}

\vspace{0.1in}

\noindent For the fitted model (using all available rib data):\\
\noindent RMSE: 360 $\pm$ 4.6  \hspace{0.05in}  Explained variation: 94.6\%
$\pm$ 0.1\%
...
\begin{frame}{Which taxa are influential in the random forest model?}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=3.25in]{use_classes/w_scapulae/classes_scapula_PercIncMSE_barchart}
    \end{figure}
  \end{center}
  \vspace{-0.1in}
  {\scriptsize
  \begin{itemize}
  \item The 12 most influential taxa used in the analysis are shown (all 17 wouldn't
  fit).)
  \end{itemize}
  }
...
\begin{frame}{Scatterplots for influential taxa}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=4.75in]{use_classes/w_scapulae/infl_scapula_class_scatter}
    \end{figure}
  \end{center}
  \vspace{-0.25in}
  {\scriptsize
  ...
  \item I've only shown top 6 because more than that is hard to fit.
  \item Note that the y-axes have differing scales.
  \item Fractions of Planctomycetia, Leptospirae, and Anaerolineae are very
  low.
  \end{itemize}
  }
...
\begin{frame}{Residual plot to get sense of "real-life" model fit}
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=2.2in]{use_classes/w_scapulae/leave_out_one_scapula_and_one_day_residuals}
      \caption{Residuals when leaving out one rib and one ADD at a time}
    \end{figure}
  \end{center}
  \vspace{-0.1in}
{\scriptsize
\begin{itemize}
  \item This RMSE is about 499, which is higher than the RMSE for the full
  dataset (as you'd expect).
\end{itemize}
}
