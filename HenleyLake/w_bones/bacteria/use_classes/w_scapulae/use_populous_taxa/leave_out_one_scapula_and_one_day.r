...
## to consider at each split is 6 (with 7 quite close) for the
...
## For 1 replicate each, this is 576.2759.
## This is about 576-578, whether I use 1, 10, or 100 runs per
## combo.
## #########################################
