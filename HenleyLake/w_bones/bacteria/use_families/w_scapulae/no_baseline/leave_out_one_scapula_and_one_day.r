...
## to consider at each split is about 19. (With numBtSamps==3000, this
## has the smallest avgcvMSE and lowest avgcvErrFrac.)  However,
## using values of 17-20 for numVarSplit yielded very similar results.
numVarSplit <- 19
## ##################################################
...
## We exclude in turn each combination of individual scapula and
## degree day. If there were no missing observations, this would be 20
## degree days x 5 individual scapulae = 100 combos.  However, we have no
## observations on 11 different combos of scapula and degdays.
...
## With 1 run per combo: 460.2229
## With 10 runs per combo: 459.7143
## With 100 runs per combo: 460.3369
## This is about 459-461, whether I use 1, 10, or 100 runs per
## combo.
## #########################################
