...
## to consider at each split is about 16.  (With numBtSamps=3000, this
## gives the 2nd smallest avgcvMSE and 3rd smallest avgcvErrFrac.)
## However, anything in the range of 13-18 would be very close.
numVarSplit <- 16
## ##################################################
...
## day. If there were no missing observations, this would be 19 degree
## days x 5 individual ribs = 95 combos.  However, we have no
...
## 1 run per combo: 743.6717
## 10 runs per combo: 741.588
## 100 runs per combo: 742.0763
...
ggplot(residDF %>%
       ...
       filter(ribnumOmit==ribnumactual),
