...
set.seed(520468)
fullResultsL <- mclapply(repDataL, mc.cores=7, fitFullDataF, mtry=numVarSplit, ntree=numBtSamps)
...
## RMSE: 555.113657   7.919834
c(mean(fullRsq), 1.96*sd(fullRsq))
## Rsq: 0.873383691 0.003612546
...
ggsave(filename="families_scapula_PercIncMSE_barchart.pdf", height=4.5, width=6, units="in")
## ##################################################
