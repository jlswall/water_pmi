...
## to consider at each split is about 7 (with 3000 bootstrap samples,
## lowest avgcvMSE and 2nd lowest avgcvErrFrac) for the response
## variable in original units.  Also, 6 and 8 are very close.
numVarSplit <- 7
## ##################################################
...
## With 1 run per combo: 1143.785
## With 10 runs per combo: 1147.382
## With 100 runs per combo: 1145.859
## This is about 1143-1148, whether I use 1, 10, or 100 runs per
## combo.
## #########################################
