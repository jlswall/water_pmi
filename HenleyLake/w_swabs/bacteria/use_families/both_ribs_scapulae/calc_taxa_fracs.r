...
# There are 17 such taxa (not including the "Rare" group).
...
# type, but not both.  Only 5 samples have these taxa in fractions above 10%,
# and three of those samples are baseline (day 0) samples. (All three of these
# are rib samples).  The other two samples are from scapula on degree days 489
# and 3962.
