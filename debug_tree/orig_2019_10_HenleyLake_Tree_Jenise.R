...
#read in OTU table 
OTU2 = read.table("/Volumes/LaCie/2019 Dissertation Data/2019_05_16_HenleyLakeDissertation/2019_11_06_HenleyLakeScapula/HLS_subsample_gg.0.05.an.shared", header=TRUE, sep="\t")
...
tax2 = read.table("/Volumes/LaCie/2019 Dissertation Data/2019_05_16_HenleyLakeDissertation/2019_11_06_HenleyLakeScapula/HLS_subsample_gg.an.0.05.cons.taxonomy", header=TRUE, sep="\t")
View(tax2)
...
#meta data file
meta = read.table("/Volumes/LaCie/2019 Dissertation Data/2019_05_16_HenleyLakeDissertation/Henley Lake Dissertation Graphs and Analysis/R Studio Directory/Cartozzo_HenleyLake/HenleyLake_Scapula_Meta_Data.txt", header=TRUE, sep = "\t")
...
#Import Tree File 
treefile <- "/Volumes/LaCie/2019 Dissertation Data/2019_05_16_HenleyLakeDissertation/2019_11_06_HenleyLakeScapula/phyloseq attempts/HLS_subsample_gg.an.unique_list.0.05.rep.otu.phylip.tre") 
tree <- import_mothur(mothur_tree_file = rtreefile)
